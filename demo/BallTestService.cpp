...
BallTestService::BallTestService()
    : BaseService("Ball Test")
{
...
void BallTestService::OnStartup()
{
...
void BallTestService::AddTestEntity(int t, const Vector2<double> &p, double s, const Color &c)
{
