...
{
    GetSM().GetService<MouseButtonEventService>().AddListener(shared_as<CreateEntityTestService>());
}

void CreateEntityTestService::OnShutdown()
{
    GetSM().GetService<MouseButtonEventService>().RemoveListener(shared_as<CreateEntityTestService>());
}
